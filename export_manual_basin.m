function export_manual_basin(varargin)

try
    info  = evalin('base','info');
    boundary  = evalin('base','s_basins');
catch
...
%     rivers(i) = struct('Geometry','Polygon','BoundingBox',BBOX,'Lon',lo,'Lat',la, 'ID',i,'BasinNo',i,'Hi',stream(i).Hi);
	rivers(i) = struct('Geometry','Polygon','BoundingBox',BBOX,'Lon',lo,'Lat',la, 'ID',i);
